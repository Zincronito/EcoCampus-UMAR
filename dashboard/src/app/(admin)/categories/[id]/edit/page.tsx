  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (density.trim() !== "") {
        ...
        payload.density_kg_per_cubic_meter = null; // Corregido: antes decía density_kg_per_liter
      }
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50/50">
        ...
        <p className="text-lg font-semibold text-slate-600">Cargando categoría...</p>
      </div>
    );
  }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div className="xl:col-span-8 space-y-8">
                ...
                <CardContent className="p-6 md:p-8 space-y-6">
                  ...
                  <div>
                    <Label htmlFor="description" className="text-[11px] font-bold text-slate-500 uppercase tracking-wider mb-2 block">
                      Descripción o Protocolos de Manejo
                    </Label>
                    <Textarea
                      id="description"
                    ...
                    <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mt-4 flex gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700/80 leading-relaxed">
                          Ajusta la densidad según los datos reales de recolección. Esta variable es clave para cálculos volumétricos.
                        </p>
                        {originalCategory?.density_kg_per_cubic_meter !== null && (
                          <div className="mt-2 text-xs font-bold text-blue-800 bg-blue-100/50 inline-block px-2 py-1 rounded">
                            Valor registrado: {originalCategory?.density_kg_per_cubic_meter} kg/m³
                          </div>
                        )}
                      </div>
                    </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                {/* Tarjeta 3: Selector de Color (Error TS ringColor Corregido) */}
                <Card className="rounded-3xl border-slate-200 shadow-sm bg-white overflow-hidden">
                  <CardHeader className="border-b border-slate-100 bg-slate-50/50 pb-4">
                    <CardTitle className="flex items-center gap-3 text-lg font-bold text-slate-950">
                      <div className="p-1.5 bg-slate-900 text-white rounded-md">
